...
public class Shell {
    ...
    public static class Paths {
        ...
        public static Path getHomePath() {
            final String envHomeVar = SystemUtils.getEnvironmentVariable("REPLAY_HOME", "user.dir");
        ...
        public static Path getAbsolutePathForExistingFile(final String filepath) {
            ...
            if (Files.exists(path)) {
                ...
                throw new RuntimeException(String.format("File '%s' is required but does not exist", path));
            }
        }
